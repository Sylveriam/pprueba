                ...
                <table class="table table-striped">
                    ...
                    for ($i = 0; $i < count($datos); $i++) {
                        ...
                        <tr>
                            ...
                            <td><a href="../views/update.php?id=<?php echo $datos[$i]["id"]; ?>">Update</a>
                                <br>
                            ...
                            <input type="button" value="borrar" class="btn btn-success" data-toggle="modal" data-target="#avisoBorrar<?= $datos[$i]["id"]; ?>"/>
                            <div class="modal fade" id="avisoBorrar<?= $datos[$i]["id"]; ?>" role="dialog">
                            <div class="modal-dialog modal-sm">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <p>Desea borrar ese dato? <?= $datos[$i]["nombre"]  ?></p>
                                    </div>
